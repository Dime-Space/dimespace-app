    ...
    <Sheet open={open} onOpenChange={onOpenChange}>
      <SheetContent side="right">
        ...
        {step === 1 && (
          ...
          >
          <Input placeholder="Nome" {...registerStep1('nome', { required: true })} className="w-64" />
            <Input placeholder="Email" type="email" {...registerStep1('email', { required: true })} className="w-64" />
            <Input placeholder="Senha" type="password" {...registerStep1('senha', { required: true })} className="w-64" />
            <Input placeholder="CPF" {...registerStep1('cpf', { required: true })} className="w-64" />
            <Input placeholder="Telefone" type="tel" {...registerStep1('telefone', { required: true })} className="w-64" />
            <Input placeholder="Área de atuação" {...registerStep1('area', { required: true })} className="w-64" />
            <select
          ...
          <Button type="submit" className="w-64">Prosseguir</Button>
        </form>
        )}
        {step === 2 && (
          <form
